...
function PlayCircle({ size = "1rem", color = "transparent", ...otherProps }) {
  return (
    <svg
      width={size}
      height={size}
...
const DEFAULT_WAVEFORM_COLORS = ["transparent", "transparent"];
                ...
                <AnimatePresence>
                  {
                    <motion.div
                      ...
                      initial={{ opacity: 0 }}import * as AspectRatio from "@radix-ui/react-aspect-ratio";
                      import cn from "classnames";
                      import { Howler, Howl } from "howler";
                      import { Suspense, lazy, useEffect, useMemo, useState } from "react";
